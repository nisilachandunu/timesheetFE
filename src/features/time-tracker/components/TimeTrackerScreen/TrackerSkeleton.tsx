...
/**
 * Stand-in for the composer bar and entry list while the client resolves what
 * day it is. Shaped closely enough to the real thing that the swap does not move
...
export function TrackerSkeleton() {
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex flex-col flex-1 min-h-0 rounded-[14px] overflow-hidden",
          "bg-surface-lowest shadow-card",
